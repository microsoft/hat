...
from benchmark_hat_package import run_basic_benchmark
...
class BenchmarkHATPackage_test(unittest.TestCase):
    ...
    def test_basic_benchmark(self):
        run_basic_benchmark(self.hatfile_path, store_in_hat=False, batch_size=2,
            min_time_in_sec=1, input_sets_minimum_size_MB=1)
