...
class Benchmark:
    ...
    def _profile(
        self, function_name, warmup_iterations, min_timing_iterations, min_time_in_sec, input_sets_minimum_size_MB
    ):
        ...
        input_sets = generate_input_sets_for_func(func, input_sets_minimum_size_MB, num_additional=10)
